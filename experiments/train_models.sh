...
PYTHONPATH='.' PYTHONUNBUFFERED="True" python tools/train_net.py --gpu 0 \
  ...
  --iters 40000 \
  2>&1 | tee output/training_demo_hha/train.log.hha
...
PYTHONPATH='.' PYTHONUNBUFFERED="True" python tools/train_net.py --gpu 2 \
  ...
  2>&1 | tee output/training_demo_rgb_vgg/train.log.images
...
PYTHONPATH='.' PYTHONUNBUFFERED="True" python tools/train_net.py --gpu 0 \
  ...
  2>&1 | tee output/training_demo_rgb_alexnet/train.log.images
